...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <actionOverrides>
        ...
        <content>Award_Record_Page</content>
        <formFactor>Large</formFactor>
        <skipRecordTypeSelect>false</skipRecordTypeSelect>
        <type>Flexipage</type>
        <pageOrSobjectType>Award__c</pageOrSobjectType>
    </actionOverrides>
    <actionOverrides>
        <actionName>Tab</actionName>
        <content>ARTT_Home</content>
        <formFactor>Large</formFactor>
        <skipRecordTypeSelect>false</skipRecordTypeSelect>
        <type>Flexipage</type>
    ...
    <profileActionOverrides>
        <actionName>View</actionName>
        <content>ARTT_Budget_Record</content>
        <formFactor>Large</formFactor>
    ...
    <tabs>ARTT_Award_Planner</tabs>
    <tabs>ARTT_Budget_Planner</tabs>
    <tabs>Award__c</tabs>
    <tabs>Document__c</tabs>
    <tabs>Adjustment__c</tabs>
    <tabs>Edit_My_Approvers</tabs>
    <tabs>Awards_Qlik_Report</tabs>
